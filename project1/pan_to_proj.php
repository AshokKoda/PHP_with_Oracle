   ...
   <head>
      ...
      <script>
         function call_convert()
         {
           ...
           url = "project_display.php?p_project_id=" + proj_name ;
           if( proj_name==""){
             //for checking
         ...
         <center>
            <form name="myForm" action="pan.js" >
               ...
               PROJECT ID: <?php
                  ...
                  $sql="select PROJECT_ID, project_id || ' - ' || PROJ_NAME  PROJ_NAME
                  from iqms_pan
                  where pan_sts IN ('APPR')
                   and project_id not in (select project_id from tels_projects)";
               ...
               <input type="button" value="Convert To Project" onclick="return call_convert()">
