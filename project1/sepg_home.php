   ...
   <head>
      ...
      <script>
         function call_recommend()
         {
           ...
           url = "pan_sepg.php?project_id=" + proj_name ;
           if( proj_name==""){
             //for checking
         ...
         <center>
            <form name="myForm" action="pan.js" >
               ...
               PROJECT ID: <?php
                  ...
                  $sql="select PROJECT_ID, PROJ_NAME  from iqms_pan where pan_sts IN ('DRAFT','REJSEPG','REJHOD')";
                  ...
                  ?>  <br><br>
               <!--button to call recommend function-->
               <input type="button" value="Recommend By SEPG" onclick="return call_recommend()">
